...
from newnanmanager_client.configuration import Configuration
from newnanmanager_client.api_response import ApiResponse, T as ApiResponseT
import newnanmanager_client.models
from newnanmanager_client import rest
from newnanmanager_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(newnanmanager_client.models, klass)
