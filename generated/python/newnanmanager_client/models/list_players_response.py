...
class ListPlayersResponse(BaseModel):
    ...
    ListPlayersResponse
    """ # noqa: E501
    players: List[Player] = Field(description="玩家列表")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListPlayersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListPlayersResponse from a dict"""
        if obj is None:
            return None
