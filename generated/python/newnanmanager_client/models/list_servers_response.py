...
class ListServersResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "servers": [ServerRegistry.from_dict(_item) for _item in obj["servers"]] if obj.get("servers") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
