...
class Ping200Response(BaseModel):
    ...
    Ping200Response
    """ # noqa: E501
    ping: StrictStr = Field(json_schema_extra={"examples": ["pong"]})
    version: StrictStr = Field(json_schema_extra={"examples": ["2.0.0"]})
    __properties: ClassVar[List[str]] = ["ping", "version"]
