...
[assembly: InternalsVisibleTo("NewNanManager.Generated.Test")]
...
namespace NewNanManager.Generated.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string ApiKeyHeaderToString(ApiKeyHeader value)
        {
            return value switch
            {
                ApiKeyHeader.X_API_Token => "X-API-Token",
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is BanPlayerRequest.BanModeEnum banPlayerRequestBanModeEnum)
                return BanPlayerRequest.BanModeEnumToJsonValue(banPlayerRequestBanModeEnum).ToString();
            if (obj is IPInfo.ThreatLevelEnum iPInfoThreatLevelEnum)
                return IPInfo.ThreatLevelEnumToJsonValue(iPInfoThreatLevelEnum).ToString();
            if (obj is IPInfo.QueryStatusEnum iPInfoQueryStatusEnum)
                return IPInfo.QueryStatusEnumToJsonValue(iPInfoQueryStatusEnum).ToString();
            if (obj is Player.BanModeEnum playerBanModeEnum)
                return Player.BanModeEnumToJsonValue(playerBanModeEnum).ToString();
            if (obj is PlayerValidateResult.BanModeEnum playerValidateResultBanModeEnum)
                return PlayerValidateResult.BanModeEnumToJsonValue(playerValidateResultBanModeEnum).ToString();
