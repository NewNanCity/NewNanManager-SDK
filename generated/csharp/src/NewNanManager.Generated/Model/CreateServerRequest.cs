...
namespace NewNanManager.Generated.Model
{
    ...
    public partial class CreateServerRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="name">服务器名称：1-100字符</param>
        /// <param name="address">服务器地址：1-255字符</param>
        /// <param name="description">服务器描述：nil、空或1-1000字符</param>
        [JsonConstructor]
        public CreateServerRequest(string name, string address, Option<string?> description = default)
        {
            Name = name;
            Address = address;
    ...
    public partial class CreateServerRequestJsonConverter : JsonConverter<CreateServerRequest>
    {
        ...
        public override CreateServerRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!address.IsSet)
                throw new ArgumentException("Property is required for class CreateServerRequest.", nameof(address));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class CreateServerRequest.");

            if (address.IsSet && address.Value == null)
                throw new ArgumentNullException(nameof(address), "Property is not nullable for class CreateServerRequest.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class CreateServerRequest.");

            return new CreateServerRequest(name.Value!, address.Value!, description);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateServerRequest createServerRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createServerRequest.Address == null)
                throw new ArgumentNullException(nameof(createServerRequest.Address), "Property is required for class CreateServerRequest.");

            if (createServerRequest.DescriptionOption.IsSet && createServerRequest.Description == null)
                throw new ArgumentNullException(nameof(createServerRequest.Description), "Property is required for class CreateServerRequest.");

            writer.WriteString("name", createServerRequest.Name);

            writer.WriteString("address", createServerRequest.Address);

            if (createServerRequest.DescriptionOption.IsSet)
                writer.WriteString("description", createServerRequest.Description);
        }
    }
}
